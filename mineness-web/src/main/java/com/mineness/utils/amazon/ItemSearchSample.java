 ...
 */
public class ItemSearchSample extends AbstractAmazonSample {
    /*
    ...
    public static void main(String[] args) {
        ...
        params.put("Keywords", "The Boxcar Children Books 1-4");
        ...
        /* Here is an example with string form, where the requests parameters have already been concatenated into a query string.
        System.out.println("String form example:");
        String queryString = "Service=AWSECommerceService&Version=2009-03-31&Operation=ItemSearch&ResponseGroup=ItemAttributes&title="
                + "Orka%2012-Inch%20Stainless%20and%20Silicone%20Tongs";
