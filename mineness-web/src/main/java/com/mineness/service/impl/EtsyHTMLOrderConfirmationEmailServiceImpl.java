 ...
 */
@Service("etsyHTMLEmailOrderConfirmationParserService")
public class EtsyHTMLOrderConfirmationEmailServiceImpl extends AbstractEmailService implements EmailParserService {
    private final static Logger log = LoggerFactory.getLogger(EtsyHTMLOrderConfirmationEmailServiceImpl.class);

    private final OrderRepository orderRepository;

    @Autowired
    public EtsyHTMLOrderConfirmationEmailServiceImpl(XMLUtility xmlUtility, OrderRepository orderRepository) {
        super(xmlUtility);
